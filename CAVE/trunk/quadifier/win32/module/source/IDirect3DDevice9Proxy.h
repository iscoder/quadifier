#ifndef hive_IDirect3DDevice9Proxy_h
#define hive_IDirect3DDevice9Proxy_h
...
/**
 * Proxy class to replace the normal IDirect3DDevice9 interface.
 */
...
#endif//hive_IDirect3DDevice9Proxy_h